  ...
  <div id="main">
    <header id="header">
      <div class="inner relative">
        ...
        <ul id="nav">
          <li><a href="javascript:void(0)" v-scroll-to="{ el: '#philosophy', offset:-70, easing: 'ease' }">{{ langRst.nav_philosophy }}</a></li>
          <li><a href="javascript:void(0)" v-scroll-to="{ el: '#service', offset:-70, easing: 'ease' }">{{ langRst.nav_service }}</a></li>
          <li><a href="javascript:void(0)" v-scroll-to="{ el: '#about', offset:-70, easing: 'ease' }">{{ langRst.nav_About }}</a></li>
          <li><a href="javascript:void(0)" v-scroll-to="{ el: '#career', offset:-70, easing: 'ease' }">{{ langRst.nav_career }}</a></li>
          <li><a href="javascript:void(0)" v-scroll-to="{ el: '#contact', offset:-70, easing: 'ease' }">{{ langRst.nav_contact }}</a></li>
        </ul>
        <!--<a href="javascript:void(0)" class="langBtn" @click="langChange"><span>{{ langTitle }}</span></a>-->
      </div>
    </header>
    <div class="main_top asyncImage" data-src="https://s3.ap-northeast-2.amazonaws.com/eosnova.io.resource/images/wzd-main-image.jpg">
      <!--<div class="gradient"></div>-->
      <div class="abs">
        <div class="inner">
          <h2>
            <img src="https://s3.ap-northeast-2.amazonaws.com/eosnova.io.resource/images/wzd-2-title.png" width="774px"/>
          </h2>
          <p>
            {{ langRst.main_title01 }}<br/>
            {{ langRst.main_title02 }}<br/>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if (this.lang === 'ko-KR' || this.lang === 'ko') {
        Object.assign(this.langRst, this.langText.ko);
        this.langState = '한글';
        this.langTitle = 'ENG';
        Object.assign(this.partnerList, this.partners.ko);
    ...
    mounted(){
      ...
      // setInterval(() => {
      //   if (i < 5) {
      //     let height = document.getElementById('nova').clientHeight,
      //       service = document.getElementById('serviceCont');
      ...
      // let domHeight = document.getElementById('nova').clientHeight,
      //     wrap = document.getElementById('serviceCont');
      // wrap.style.height = domHeight+'px';
    ...
    methods : {
      tabCtrl( btn ){
        ...
        for (let i = 0; i < tabChild.length; i++) {
          ...
          // if( conChild[i].classList.contains('on') ) this.domHeight = conChild[i].clientHeight;
        }
        // wrap.style.height = this.domHeight+'px';
      },
      getWindowWidth() {
        // this.windowWidth = document.documentElement.clientWidth;
        let tabChild = document.getElementById('serviceCont').children,
          wrap = document.getElementById('serviceCont');
        this.tabConHeight = [];
        for (let i = 0; i < tabChild.length; i++) {
          // if( tabChild[i].classList.contains('on') ) this.domHeight = tabChild[i].clientHeight;
        }
        // wrap.style.height = this.domHeight+'px';
      },
      scroll(){
